...
router.get('/qtdComputadores/:fkEmpresa', function(req, res, next) {
	...
	let instrucaoSql = `SELECT idTorre, nomeTorre, cidadeTorre, estadoTorre, idComputador from tbcomputadores join tbtorres  where idTorre = fkTorre and fkEmpresa = ${fkEmpresa};`;
	console.log(instrucaoSql);
